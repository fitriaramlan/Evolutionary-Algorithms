...
for i = 1:30   
    ...
    eval(['load D:\OUR_CODES\NEW_SRA_GRID\RES-New_SRA_GRIDmating-DTLZ\New_SRA_GRIDmating-DTLZ','_',num2str(p),'_',num2str(obj),'_',num2str(i)]);
...
for i = 1:30   
    ...
    eval(['load D:\OUR_CODES\SDE-trails-NOV18\SIR_SDE-Modifications_NOV19\NSGAIISDE_DTLZ\NSGAIISDE_DTLZ\NSGAII-SDE_D','_',num2str(p),'_',num2str(obj),'_',num2str(i)]);
