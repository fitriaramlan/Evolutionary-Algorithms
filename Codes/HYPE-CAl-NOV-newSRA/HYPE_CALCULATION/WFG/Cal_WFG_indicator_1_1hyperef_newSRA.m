...
for i = 1:30
    ...
    eval(['load D:\OUR_CODES\NEW_SRA_GRID\New_SRA-WFG\RES-New_SRA_GRISmating-WFG\New_SRA_GRIDmating-WFG','_',num2str(p),'_',num2str(obj),'_',num2str(i)]);
...
%  V13 = zeros(1,30); 
  ...
  for i = 1 : 30
     ...
     V3(i) = Hypervolume(F,1.1.*ones(1,size(F,2)),1000);
