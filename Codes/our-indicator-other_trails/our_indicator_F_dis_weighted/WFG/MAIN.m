...
%-----------------------------------------------------------------------------------------      
  ...
  for Gene = 1 : Generations
        ...
        DistanceValue    = F_distance(F);    % calculate the crowding-distance values

       
        [~,rank]                 = sort(DistanceValue,'decend');% sort these solutions according to their crowding-distance values
     ...
     F_output(Population,toc,'WFG-MSDE+GRIDdiv-10',testNo,M,k,l,run);
  end
