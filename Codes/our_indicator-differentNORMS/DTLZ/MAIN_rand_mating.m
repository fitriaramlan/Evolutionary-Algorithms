...
%-----------------------------------------------------------------------------------------      
  for run = 1: Runs
    ...
    DistanceValue                 = F_distance_sir(FunctionValue,M,p); 
%-----------------------------------------------------------------------------------------      
    % start iterations
    for Gene = 1 : Generations
     ...
     %   MatingPool          = MatingSelection(FunctionValue,10);
        ...
        DistanceValue    = F_distance_sir(FunctionValue,M,p);    % calculate the crowding-distance values
