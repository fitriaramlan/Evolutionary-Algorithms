...
for i = 1:15
 ...
 eval(['load D:\ARCHIVE-BASED\NAGA-II\NSGA-II-DTLZ\NSGA-II-DTLZ_modified(may1)\NSGA-II-DTLZ-Modified\NSGA-II-dtlz-MOD','_',num2str(p),'_',num2str(obj),'_',num2str(i)]);
 ...
 eval(['load D:\ARCHIVE-BASED\NAGA-II\NSGA-II-DTLZ\NAGS-11-Dtlz-modified(May2)\NSGA-II-DTLZ-Modified\NSGA-II-dtlz-MOD','_',num2str(p),'_',num2str(obj),'_',num2str(i)]);
