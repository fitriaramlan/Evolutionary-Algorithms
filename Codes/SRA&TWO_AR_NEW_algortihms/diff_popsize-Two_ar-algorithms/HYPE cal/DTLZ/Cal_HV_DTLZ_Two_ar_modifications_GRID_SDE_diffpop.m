...
for i = 1:30   
    ...
    eval(['load D:\OUR_CODES\SRA&TWO_AR_NEW_algortihms\diff_popsize-Two_ar-algorithms\two-ar-diffPOP-NEW\two-archiv-me-dtlz-diffPOP(new)\Two_Ar-DTLZ-diffpop\Two-Archive2','_',num2str(p),'_',num2str(obj),'_',num2str(i)]);
...
for i = 1:30   
    ...
    eval(['load D:\OUR_CODES\SRA&TWO_AR_NEW_algortihms\diff_popsize-Two_ar-algorithms\Two-ar-Grid_SDE_(unique_obj&POP)_diffpop\DTLZ_codefor_obj&POP\UNique-POPspace_DTLZ\Two-Ar-GRID+SDE','_',num2str(p),'_',num2str(obj),'_',num2str(i)]);
...
for i = 1:30   
    ...
    eval(['load D:\OUR_CODES\SRA&TWO_AR_NEW_algortihms\diff_popsize-Two_ar-algorithms\Two-ar-Grid_SDE_(unique_obj&POP)_diffpop\DTLZ_codefor_obj&POP\unique_objspace_Two_arGRID+SDE-DTLZ\Two-Ar-GRID+SDE','_',num2str(p),'_',num2str(obj),'_',num2str(i)]);
