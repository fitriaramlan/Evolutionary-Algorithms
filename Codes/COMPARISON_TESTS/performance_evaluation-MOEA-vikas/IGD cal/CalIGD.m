for obj= [4 6 8 10]
    ...
    for p = 1 : 7
        ...
        for i = 1:30
            ...
            eval(['load D:\IGDcal\KnEA-ANSD\KnEA-ANSD','_',num2str(p),'_',num2str(obj),'_',num2str(i)]);
        ...
        for i = 1:30
            ...
            eval(['load D:\IGDcal\KnEA-SR9D\KnEAAS9','_',num2str(p),'_',num2str(obj),'_',num2str(i)]);
