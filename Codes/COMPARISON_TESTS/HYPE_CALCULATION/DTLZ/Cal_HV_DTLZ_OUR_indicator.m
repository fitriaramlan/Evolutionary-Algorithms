...
%%GR+GCD(mating)+sde(indicator ES)
% for i = 1:30
%     
...
% for i = 1:30   
%     
%     eval(['load D:\OUR_CODES\our_indicator_F_dis_weighted\DTLZ\DTLZ-ISDE+_weighted\DTLZ-ISDE+','_',num2str(p),'_',num2str(obj),'_',num2str(i)]);
%     
%     C = [ C ; FunctionValue ];
%     
% end
...
% for i = 1:30   
%     
%     eval(['load D:\OUR_CODES\our_indicator_(NN==1)\DTLZ\DTLZ-ISDE+\DTLZ-ISDE+','_',num2str(p),'_',num2str(obj),'_',num2str(i)]);
%     
%     C = [ C ; FunctionValue ];
%     
% end
