...
%  for i = 1:30
%     
%     eval(['load D:\OUR_CODES\our_indicator_F_dis_weighted\WFG\WFG-ISDE+_weighted\WFG-ISDE+','_',num2str(p),'_',num2str(obj),'_',num2str(i)]);
%     
%     C = [ C ; F ];
%  end
 
 %  for i = 1:30
%   %     eval(['load D:\OUR_CODES\our_indicator_(NN==1)\WFG\WFG-ISDE+\WFG-ISDE+','_',num2str(p),'_',num2str(obj),'_',num2str(i)]);
%     
%     C = [ C ; F ];
%  end
 for i = 1:30
