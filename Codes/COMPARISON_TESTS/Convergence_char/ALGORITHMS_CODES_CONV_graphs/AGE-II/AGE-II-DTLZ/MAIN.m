...
%-----------------------------------------------------------------------------------------      
    ...
    for Gene = 1 : Generations
     ...
     %%convergence graphs AND igd,gd,DELTA CALCUL;ATIONS
                    ...
                    save(['C:\Users\ECIS\Desktop\TRINADH\Convergence_char\ALGORITHMS_CODES_CONV_graphs\AGE-II\AGE-II-DTLZ\IGD_GD_DELTA_gen\IGD_GD_DELTA_gen_D' num2str(Problem) '_M' num2str(M) '_run' num2str(run) '.mat'],'result');
