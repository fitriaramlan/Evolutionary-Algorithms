...
for i = 1:30
 ...
 eval(['load D:\ARCHIVE-BASED\NAGA-II\NSGA-II_W\NSGA-II','_',num2str(p),'_',num2str(obj),'_',num2str(i)]);
...
for i = 1:30
 ...
 eval(['load D:\ARCHIVE-BASED\NAGA-II\NSGA-II_Modified-May-wfg\result_NSGAII_wfg_Modified-Fgen\NSGA-II_MOD-Fgen','_',num2str(p),'_',num2str(obj),'_',num2str(i)]);
