...
%-----------------------------------------------------------------------------------------      
   ...
   %%convergence graphs AND igd,gd,DELTA CALCUL;ATIONS
                    ...
                    save(['D:\OUR_CODES\COMPARISON_TESTS\Convergence_char\ALGORITHMS_CODES_CONV_graphs\BiGEdtlz\IGD_GD_DELTA_gen\IGD_GD_DELTA_gen_D' num2str(Problem) '_M' num2str(M) '_run' num2str(run) '.mat'],'result');
            ...
            for r=1:Runs
                eval(['load D:\OUR_CODES\COMPARISON_TESTS\Convergence_char\ALGORITHMS_CODES_CONV_graphs\BiGEdtlz\IGD_GD_DELTA_gen\IGD_GD_DELTA_gen_D' num2str(Problem) '_M' num2str(M) '_run' num2str(r) '.mat']);
                tot=tot+result;
                
            end
            FinalMean=tot./Runs;
            eval(['save D:\OUR_CODES\COMPARISON_TESTS\Convergence_char\FINAL_PLOTvalues\BiGE','_', num2str(Problem),'_',num2str(M),'.mat']);
