function F_output(Population,time,Algorithm,Problem,M,K,l,run)
% This function is used for deleting the dominated solutions, 
% and saving the result in the file

    
    F = wfg(Population,M,K,l,Problem);
    ...
    eval(['save SPEA2+SDE-our-WFG\', Algorithm,'_', num2str(Problem),'_', num2str(M),'_', num2str(run), ' Population F time'])
